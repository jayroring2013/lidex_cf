...
function InfoItem({ icon: Icon, label, value }: { icon: any; label: string; value: string }) {
  return (
    <div className="p-2.5 sm:p-3 rounded-lg" style={{ background: 'var(--content-detail-tile-bg)', border: '1px solid var(--content-detail-tile-border)' }}>
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{ background: 'var(--content-detail-tile-bg)', color: 'var(--foreground-muted)', border: '1px solid var(--content-detail-tile-border)' }}
          >
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            style={{
              background: canPrev ? 'var(--content-detail-tile-bg)' : 'transparent',
          ...
          <button
            ...
            className="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-150 disabled:opacity-30 disabled:cursor-not-allowed"
            style={{
              background: canNext ? 'var(--content-detail-tile-bg)' : 'transparent',
              border: '1px solid var(--content-detail-tile-border)',
              color: 'var(--foreground-secondary)',
            }}
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  border: isActive
                    ? '2px solid #6366f1'
                    : '1px solid var(--content-detail-tile-border)',
